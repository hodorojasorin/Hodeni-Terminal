# Hodeni Terminal by ASH

![Terminal Portfolio Website by Sat Naing, implimenting by ASH](https://user-images.githubusercontent.com/53733092/194220661-e2ff8b4c-f64a-4b64-a836-c52fae6bbcda.png)
...
Hodeni Terminal is built with React, TypeScript, and Styled-Components by Sat Naing, who developed the visual interface and UI components.
My contribution to the project includes implementing the database, adding new functionalities, developing the authentication and login system, creating the administration panel, and building a more advanced terminal tailored for the requirements of our college project.
The application supports multiple themes and includes keyboard shortcuts for various features.
